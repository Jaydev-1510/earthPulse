...
![Screenshot](https://github.com/user-attachments/assets/5c6ed412-554d-4506-9ac1-1430f8ade118)
![Screenshot](https://github.com/user-attachments/assets/a69da243-30e1-491d-b010-19120b718f76)
...
- Earthquake data is provided by the [USGS public API](https://earthquake.usgs.gov/earthquakes)
- Aurora data is provided by the [SWPC NOAA API](https://services.swpc.noaa.gov/)
- Live ISS position is provided by the [Where the ISS at](https://wheretheiss.at/)

---

## Special mention

The React [Three Fiber Globe (R3F-globe)](https://github.com/vasturiano/r3f-globe/) by [@vasturiano/](https://github.com/vasturiano/) is an indispensable component of this project and has made this project possible.
